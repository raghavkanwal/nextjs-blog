...
export default function BlogPage() {
    ...
    const postsPreviews = postsMetaData.map((post: Post, postIdx: number) => {
        return (<div key={postIdx}>
            <Link href={`/posts/${post.slug}`} ><div className="max-w-lg bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <Image className="rounded-t-lg" src={`/${post.banner}`} alt={post.title} width="600" height="300" />
                <div className="p-5">
                    <a href="#">
